...
#    ifdef DEAL_II_HAVE_CXX20
    static_assert(concepts::is_vector_space_vector<BlockVector<float>, MemorySpace::Host>);
#    endif
    template class BlockVector<float, MemorySpace::Host>;
#  endif
#  ifdef HAVE_TPETRA_INST_DOUBLE
#    ifdef DEAL_II_HAVE_CXX20
    static_assert(concepts::is_vector_space_vector<BlockVector<double>, MemorySpace::Host>);
#    endif
