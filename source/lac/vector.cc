...
Vector<float>::operator=
  <float>(const LinearAlgebra::TpetraWrappers::Vector<float, MemorySpace::Host> &);
template Vector<float> &
Vector<float>::operator=
  <float>(const LinearAlgebra::TpetraWrappers::Vector<float, MemorySpace::Default> &);
#  endif
...
Vector<double>::operator=
  <double>(const LinearAlgebra::TpetraWrappers::Vector<double, MemorySpace::Host> &);
template Vector<double> &
Vector<double>::operator=
  <double>(const LinearAlgebra::TpetraWrappers::Vector<double, MemorySpace::Default> &);
#  endif
