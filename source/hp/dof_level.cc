...
namespace internal
{
  namespace hp
  {
    ...
    {
      for (unsigned short &active_fe_indice : active_fe_indices)
        if (is_compressed_entry(active_fe_indice))
          active_fe_indice = get_toggled_compression_state(active_fe_indice);
    }
