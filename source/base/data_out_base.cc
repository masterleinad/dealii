        ...
        for (unsigned int i3 = 0; i3 < n3; ++i3)
          for (unsigned int i2 = 0; i2 < n2; ++i2)
            for (unsigned int i1 = 0; i1 < n1; ++i1)
              {
                node = compute_node(patch, i1, i2, i3, n_subdivisions);
                ...
                for (unsigned int i1 = 0; i1 < n1; ++i1)
                  {
                    ...
                    node = compute_node(patch, i1, i2, 0, n_subdivisions);
                    out << node << ' ';
                    ...
                    if (i1 < n_subdivisions)
                      {
                        ...
                        node =
                          compute_node(patch, i1 + 1, i2, i3, n_subdivisions);
                        out << node;
                    ...
                    if (i2 < n_subdivisions)
                      {
                        ...
                        // write point there and its data
                        node =
                          compute_node(patch, i1, i2 + 1, i3, n_subdivisions);
                        out << node;
                    ...
                    if (i3 < n_subdivisions)
                      {
                        ...
                        // write point there and its data
                        node =
                          compute_node(patch, i1, i2, i3 + 1, n_subdivisions);
                        out << node;
