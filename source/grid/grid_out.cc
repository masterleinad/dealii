  ...
  if(ucd_flags.write_preamble)
    {
      ...
      out << "# This file was generated by the deal.II library." << '\n'
          ...
          << "/" << time->tm_mday << '\n'
          << "# Time =  " << time->tm_hour << ":" << std::setw(2)
          << time->tm_min << ":" << std::setw(2) << time->tm_sec << '\n'
          << "#" << '\n'
          << "# For a description of the UCD format see the AVS Developer's "
             "guide."
          << '\n'
          << "#" << '\n';
    }
...
GridOut::write_svg(const Triangulation<2, 2>& tria, std::ostream& out) const
{
  ...
  if(svg_flags.background == GridOutFlags::Svg::dealii)
    {
      out << " <linearGradient id=\"background_gradient\" "
             "gradientUnits=\"userSpaceOnUse\" x1=\"0\" y1=\"0\" x2=\"0\" y2=\""
          << height << "\">" << '\n'
  ...
  if(svg_flags.background == GridOutFlags::Svg::dealii)
    {
      ...
      out << " <text x=\"" << x_offset << "\" y=\""
          << static_cast<unsigned int>(.5 + height * .0525) << '\"'
          << " style=\"font-weight:100; fill:lightsteelblue; "
             "text-anchor:start; font-family:Courier; font-size:"
  ...
  if(true)
    {
      ...
      out << "\n#"
          ...
          << time->tm_sec << "\n#"
          << "\n# For a description of the MathGL script format see the MathGL "
             "manual.  "
          << "\n#"
          << "\n# Note: This file is understood by MathGL v2.1 and higher "
             "only, and can "
          << "\n#       be quickly viewed in a graphical environment using "
             "\'mglview\'. "
          << "\n#"
          << "\n";
    }
  ...
  switch(dim)
    {
      case 2:
        ...
        break;
      case 3:
        out << "\nlist f 0 2 4 6 | 1 3 5 7 | 0 4 1 5 | 2 6 3 7 | 0 1 2 3 | 4 5 "
               "6 7"
            << "\n";
        break;
      default:
          ...
          if((dim == 2)
                 ...
                 || eps_flags_2.write_vertex_numbers))
            {
              out << ("/R {rmoveto} bind def\n"
                      ...
                      "/MFshow {{dup dup 0 get findfont exch 1 get scalefont "
                      "setfont\n"
                      "[ currentpoint ] exch dup 2 get 0 exch rmoveto dup dup "
                      "5 get exch 4 get\n"
                      "{show} {stringwidth pop 0 rmoveto}ifelse dup 3 get\n"
                      "{2 get neg 0 exch rmoveto pop} {pop aload pop "
                      "moveto}ifelse} forall} bind def\n"
                      "/MFwidth {0 exch {dup 3 get{dup dup 0 get findfont exch "
                      "1 get scalefont setfont\n"
