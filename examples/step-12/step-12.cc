...
// of local integrals as well in its base class Meshworker::LocalResults.  In
// the second of these files, we find an object of type
...
namespace Step12
{
  ...
  // not have a AffineConstraints, because there are no hanging node constraints
