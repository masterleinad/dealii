...
namespace Step37
{
  ...
  // AffineConstraints::distribute_local_to_global call does), it does
  // not compute any contribution for constrained degrees of freedom, leaving
  // the respective entries zero. This would represent a matrix that had empty
  ...
  // boundary described by the AffineConstraints object inside
  // MatrixFree or the indices at the interface between different grid levels in
  // adaptive multigrid). This is done through the function
