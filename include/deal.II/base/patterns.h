...
namespace Patterns
{
  ...
  namespace Tools
  {
                   ...
                   std::enable_if_t<std::is_arithmetic<T>::value>>
    {
      ...
      template <typename Dummy = T>
      static
        std::enable_if_t<std::is_same<Dummy, T>::value &&                                  !std::is_same<T, bool>::value &&                                  std::is_integral<T>::value,                                std::unique_ptr<Patterns::PatternBase>>
        to_pattern()
      {
      ...
      template <typename Dummy = T>
      static
        std::enable_if_t<std::is_same<Dummy, T>::value &&                                  !std::is_same<T, bool>::value &&                                  std::is_floating_point<T>::value,                                std::unique_ptr<Patterns::PatternBase>>
        to_pattern()
      {
