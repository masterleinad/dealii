...
namespace parallel
{
  ...
  public:
     ...
     */
    void copy_triangulation (const dealii::Triangulation<dim, spacedim> &old_tria) override;
     ...
     * the triangulation.
     */
    types::global_dof_index n_global_active_cells () const override;
     ...
     */
    unsigned int n_global_levels () const override;
