  ...
  public:
    ...
    print_info(std::ostream& out) const override
    {
      out
        ...
        << "a sufficiently large number of iterations for your iterative "
           "solver "
        << "to converge. This often happens when you increase the size of your "
        << "problem. In such cases, the last residual will likely still be "
           "very "
        << "small, and you can make the error go away by increasing the "
           "allowed "
        ...
        << "cases, the residual in the last iteration is likely going to be "
           "large."
        << std::endl;
    }
