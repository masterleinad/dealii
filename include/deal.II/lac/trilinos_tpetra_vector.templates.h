...
#  endif
    ...
    template <typename Number, typename MemorySpace>
    void
    Vector<Number, MemorySpace>::import_elements(const ReadWriteVector<Number> &V,
                                    VectorOperation::values        operation)
    {
    ...
    template <typename Number, typename MemorySpace>
    Number
    Vector<Number, MemorySpace>::operator*(const Vector<Number, MemorySpace> &V) const
    {
      Assert(this->size() == V.size(),
             ExcDimensionMismatch(this->size(), V.size()));
...
#  endif
    ...
    template <typename Number, typename MemorySpace>
    void
    Vector<Number, MemorySpace>::add(const Number a, const Vector<Number, MemorySpace> &V)
    {
      AssertIsFinite(a);
    ...
    template <typename Number, typename MemorySpace>
    void
    Vector<Number, MemorySpace>::scale(const Vector<Number, MemorySpace> &scaling_factors)
    {
    ...
    template <typename Number, typename MemorySpace>
    void
    Vector<Number, MemorySpace>::equ(const Number a, const Vector<Number, MemorySpace> &V)
    {
      AssertIsFinite(a);
    ...
    template <typename Number, typename MemorySpace>
    Number
    Vector<Number, MemorySpace>::add_and_dot(const Number          a,
                                const Vector<Number, MemorySpace> &V,
                                const Vector<Number, MemorySpace> &W)
    {
      AssertIsFinite(a);
    ...
    template <typename Number, typename MemorySpace>
    void
    Vector<Number, MemorySpace>::compress(const VectorOperation::values operation)
    {
...
#  endif
    ...
    template <typename Number, typename MemorySpace>
    void
    Vector<Number, MemorySpace>::create_tpetra_comm_pattern(const IndexSet &source_index_set,
