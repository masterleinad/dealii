...
public:
   ...
   */
  std::unique_ptr<MappingFEField<dim,spacedim,VectorType,DoFHandlerType> >
  clone () const
  {
    return  std::unique_ptr<MappingFEField<dim,spacedim,VectorType,DoFHandlerType> >(raw_clone());
  }
