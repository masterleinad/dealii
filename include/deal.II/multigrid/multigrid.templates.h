...
{
  Assert (min_level >= matrix->get_min_level(),
          ExcLowerRangeType<unsigned int>(min_level, matrix->get_min_level()));
  Assert (max_level <= matrix->get_max_level(),
          ExcLowerRangeType<unsigned int>(matrix->get_max_level(), max_level));
