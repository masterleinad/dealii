...
namespace mg
{
  ...
  public:
    ...
    virtual unsigned int get_min_level() const;
    virtual unsigned int get_max_level() const;
...
namespace mg
{
  ...
  template <typename VectorType>
  unsigned int
  Matrix<VectorType>::get_min_level() const
  {
  ...
  template <typename VectorType>
  unsigned int
  Matrix<VectorType>::get_max_level() const
  {
