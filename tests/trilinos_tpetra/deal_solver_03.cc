...
main(int argc, char **argv)
{
...

  {
    ...
    GrowingVectorMemory<LinearAlgebra::TpetraWrappers::Vector<double, MemorySpace::Default>> mem;
    SolverGMRES<LinearAlgebra::TpetraWrappers::Vector<double, MemorySpace::Default>>::AdditionalData
                                                               sol_data(28);
    SolverGMRES<LinearAlgebra::TpetraWrappers::Vector<double, MemorySpace::Default>> solver(control,
                                                                      mem,
                                                                      sol_data);
