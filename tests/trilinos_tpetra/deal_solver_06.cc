...
main(int argc, char **argv)
{
...

  {
    ...
    SolverRichardson<LinearAlgebra::TpetraWrappers::Vector<double, MemorySpace::Default>>::
      AdditionalData data(
        /*omega=*/0.1);
    SolverRichardson<LinearAlgebra::TpetraWrappers::Vector<double, MemorySpace::Default>> solver(
      control, mem, data);
