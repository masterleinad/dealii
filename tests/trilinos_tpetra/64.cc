    ...
    {
      {
        ...
        LinearAlgebra::TpetraWrappers::SparseMatrix<double, MemorySpace::Default> v1(n_dofs,
                                                               n_dofs,
                                                               5U);
        test(v1);
        ...
        LinearAlgebra::TpetraWrappers::SparseMatrix<double, MemorySpace::Default> v2(local_rows,
                                                               MPI_COMM_WORLD,
                                                               5);
        test(v2);
      }
