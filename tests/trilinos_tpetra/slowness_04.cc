...
test()
{
  ...
  LinearAlgebra::TpetraWrappers::SparseMatrix<double, MemorySpace::Default> matrix(indices,
                                                             MPI_COMM_WORLD,
                                                             5);
  ...
  // of the matrix norm
  LinearAlgebra::TpetraWrappers::Vector<double, MemorySpace::Default> v1(indices, MPI_COMM_WORLD);
  LinearAlgebra::TpetraWrappers::Vector<double, MemorySpace::Default> v2(indices, MPI_COMM_WORLD);
