...
test()
{
  ...
  LinearAlgebra::TpetraWrappers::Vector<Number, MemorySpace::Default> a(parallel_partitioner_1,
                                                  MPI_COMM_WORLD);
  LinearAlgebra::TpetraWrappers::Vector<Number, MemorySpace::Default> b(parallel_partitioner_1,
                                                  MPI_COMM_WORLD);
  LinearAlgebra::TpetraWrappers::Vector<Number, MemorySpace::Default> c(parallel_partitioner_2,
                                                  MPI_COMM_WORLD);
