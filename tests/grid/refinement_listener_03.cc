...
test()
{
  ...
  boost::signals2::connection connections_1[5]
    = {tria_1.signals.pre_refinement.connect(std::bind(
       ...
       tria_1.signals.create.connect(std::bind(
         &create_notification<dim, dim>, "tria_1", std::cref(tria_1))),
  ...
  boost::signals2::connection connections_2[5]
    = {tria_2.signals.pre_refinement.connect(std::bind(
       ...
       tria_2.signals.create.connect(std::bind(
         &create_notification<dim, dim>, "tria_2", std::cref(tria_2))),
